...
st.set_page_config(page_title="3-Way Betting Calculator", layout="centered")
st.markdown("""
    <style>
        .main {
...
st.title("🎲 3-Way Betting Calculator")
...
odd3 = st.number_input("Enter Odds for Draw:", min_value=0.01, format="%.2f")

# Calculation and output
if st.button("Calculate Bets"):
    try:
        R = investment / (1/odd1 + 1/odd2 + 1/odd3)
        bet1 = R / odd1
        bet2 = R / odd2
        bet3 = R / odd3
        profit = R - investment
